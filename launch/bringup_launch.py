...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('nav2_bringup') # Comentado para cambiar a línea de invocacion local
    ...
    active_slam_sel = LaunchConfiguration('active_slam_sel') # Añadido para desactivar slam o alternativa
    ...
    declare_active_slam_sel = DeclareLaunchArgument( # Añadido para desactivar slam o alternativa
        'active_slam_sel', default_value='True',
