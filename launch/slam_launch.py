...
def generate_launch_description():
    ...
    ## LOCALES ##
    local_bringup_dir = get_package_share_directory('sm_isaac_exploration')
    local_launch_dir = os.path.join(local_bringup_dir, 'launch')

    local_slam_toolbox_dir = get_package_share_directory('sm_isaac_exploration')
    local_slam_launch_file = os.path.join(local_slam_toolbox_dir, 'launch', 'online_sync_launch.py')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(local_bringup_dir, 'config', 'rtx_carter_navigation_params.yaml'),
