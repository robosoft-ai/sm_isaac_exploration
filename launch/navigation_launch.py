...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('sm_isaac_exploration')
    ...
    param_substitutions = {
        ...
        "default_nav_to_pose_bt_xml": os.path.join(
            bringup_dir, "config", "navigation_tree.xml"
        ),}
    ...
    default_nav_to_pose_bt_xml = DeclareLaunchArgument(
                ...
                default_value= os.path.join(get_package_share_directory("sm_isaac_exploration"), "config", "navigation_tree.xml"),
