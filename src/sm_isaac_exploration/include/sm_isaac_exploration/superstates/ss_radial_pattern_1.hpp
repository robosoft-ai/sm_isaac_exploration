...
using namespace sm_isaac_exploration::radial_motion_states;
...
public:
  ...
  // TRANSITION TABLE
  typedef mpl::list<
      Transition<EvLoopEnd<StiRadialLoopStart>, StLaunchExploration, ENDLOOP> //,
...
#include <sm_isaac_exploration/states/radial_motion_states/sti_radial_end_point.hpp>
#include <sm_isaac_exploration/states/radial_motion_states/sti_radial_loop_start.hpp>
#include <sm_isaac_exploration/states/radial_motion_states/sti_radial_return.hpp>
#include <sm_isaac_exploration/states/radial_motion_states/sti_radial_rotate.hpp>
} // namespace SS1
} // namespace sm_isaac_exploration
