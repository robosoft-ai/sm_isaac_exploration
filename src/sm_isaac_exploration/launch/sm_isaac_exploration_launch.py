...
def generate_launch_description():
    ...
    # urdf = os.path.join(sm_isaac_exploration_dir, "urdf", "turtlebot3_waffle.urdf")
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config_file",
        default_value=os.path.join(sm_isaac_exploration_dir, "rviz", "nav2_default_view.rviz"),
    ...
    #     PythonLaunchDescriptionSource(os.path.join(sm_isaac_exploration_launch_dir, "rviz_launch.py")),
    ...
    #     PythonLaunchDescriptionSource(os.path.join(sm_isaac_exploration_launch_dir, "bringup_launch.py")),
    #     launch_arguments={
    #         "namespace": namespace,
    ...
    sm_isaac_exploration_node = Node(
        package="sm_isaac_exploration",
        executable="sm_isaac_exploration_node",
        name="SmIsaacExploration",
        output="screen",
        # prefix=xtermprefix + " gdb -ex run --args",
        prefix="xterm -hold -e",
        parameters=[
            os.path.join(
                get_package_share_directory("sm_isaac_exploration"),
                "config/sm_isaac_exploration_config.yaml",
            )
        ],
        remappings=[
            # ("/odom", "/odometry/filtered"),
            # ("/sm_isaac_exploration_2/odom_tracker/odom_tracker_path", "/odom_tracker_path"),
            # ("/sm_isaac_exploration_2/odom_tracker/odom_tracker_stacked_path", "/odom_tracker_path_stacked")
        ],
