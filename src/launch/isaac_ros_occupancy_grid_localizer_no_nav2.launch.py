...
def generate_launch_description():
    ...
    map_file_arg = DeclareLaunchArgument(
        ...
        #         'sm_isaac_exploration'), 'maps', 'improved_carter_warehouse_navigation.yaml'),
        'map_file', default_value='/tmp/saved_map.yaml',
        description='Full path to map file to load')
    params_file_arg = DeclareLaunchArgument(
        'params_file', default_value=os.path.join(
            get_package_share_directory(
                # 'isaac_ros_occupancy_grid_localizer'), 'params', 'carter_nav2.yaml'),
                'sm_isaac_exploration'), 'config', 'rtx_carter_navigation_params.yaml'),
